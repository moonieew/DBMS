		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Please fill in your information to register</div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<form role="form" action="register" method="post">
									...
									<div class="form-group">
										<label>Repassword</label> <input class="form-control"
											placeholder="please enter password" type="password"
											name="repassword"   />
									</div>
									<div class="form-group">
									...
									<button type="button" class="btn btn-primary">Go to Login</button></a>
								</form>
